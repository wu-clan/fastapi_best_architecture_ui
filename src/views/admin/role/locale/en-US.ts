export default {
  'menu.system.sysRole': 'Role manage',
  // form
  'admin.role.form.name': 'Menu name',
  'admin.role.form.name.placeholder': 'Please enter a menu name',
  'admin.role.form.name.help': 'Menu name is required',
  'admin.role.form.status': 'Status',
  'admin.role.form.status.1': 'Enable',
  'admin.role.form.status.0': 'Disable',
  ...
  // columns
  'admin.role.columns.new.drawer': 'New role',
  ...
  'admin.role.columns.perms': 'Permission',
